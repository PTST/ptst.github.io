...
var formatGoogleCalendar = (function() {
    ...
    var formatDateSameDay = function(dateStart, dateEnd, moreDaysEvent, isAllDayEvent, dayNames) {
        ...
        return '<h3>' + dayNameStart + 'd. ' + dateStart[0] + '. ' + getMonthName(dateStart[1]) + ', ' + dateStart[2] + '</h3>' + formattedTime;
    };
    ...
    var formatDateOneDay = function(dateStart, dayNames) {
      ...
      //month day, year
      return dayName + 'd. ' + dateStart[0] + '. ' + getMonthName(dateStart[1]) + ', ' + dateStart[2];
    };
    ...
    var formatDateDifferentDay = function(dateStart, dateEnd, dayNames) {
      ...
      if (dayNames) {
        ...
        //month day-day, year
        return dayNameStart + 'd. ' + dateStart[0] + '. ' + getMonthName(dateStart[1]) + '-' + dayNameEnd + 'd. ' + dateEnd[0] + ', ' + dateStart[2];
    };
    ...
    var formatDateDifferentMonth = function(dateStart, dateEnd, dayNames) {
      ...
      if (dayNames) {
        ...
        return dayNameStart + 'd. ' + dateStart[0] + '. ' + getMonthName(dateStart[1]) + '-' + dayNameEnd + 'd. ' + dateEnd[0] + '. ' + getMonthName(dateEnd[1]) + ', ' + dateStart[2];
    };
    ...
    var formatDateDifferentYear = function(dateStart, dateEnd, dayNames) {
      ...
      if (dayNames) {
        ...
        return dayNameStart + 'd. ' + dateStart[0] + '. ' + getMonthName(dateStart[1]) + ', ' + dateStart[2] + '-' + dayNameEnd + 'd. ' + dateEnd[0] + '. ' + getMonthName(dateEnd[1]) + ', ' + dateEnd[2];
    };
